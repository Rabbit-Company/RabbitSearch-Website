...
function displayGeneralResults(results){
	...
	for(let i = 0; i < results.data.webPages.value.length; i++){
		...
		<svg xmlns="http://www.w3.org/2000/svg" class="text-amber-600 align-bottom h-5 w-5" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
		...
		<span>${escapeHtml(results.data.webPages.value[i].name)}</span></a>
